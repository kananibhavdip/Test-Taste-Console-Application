...
namespace Test_Taste_Console_Application.Domain.Services
{
    ...
    public class ScreenOutputService : IOutputService
    {
        ...
        {
            Logger.Instance.Info("Planets Loading Data Start ...");
            //The service gets all the planets from the API.
            var planets = _planetService.GetAllPlanets().ToArray();
            Logger.Instance.Info("Planets Loading Data End ..."); 

            Logger.Instance.Info("Planets Data Writing Start...");
            ...
            if (!planets.Any())
            {
                ...
                Logger.Instance.Info("Planets Data Writing End...");
                return;
            }
        ...
        {
            Logger.Instance.Info("Moons Loading Data Start ...");
            ...
            Logger.Instance.Info("Moons Loading Data End ...");

            Logger.Instance.Info("Moons Data Writing Start...");

            if (!moons.Any())
            {
                Console.WriteLine(OutputString.NoMoonsFound);                
                Logger.Instance.Info("Moons Data Writing End...");            
                return;
            }
